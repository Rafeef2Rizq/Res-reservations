                ...
                <form method="post" action="{{route('admin.menu.store')}}" enctype="multipart/form-data">
                    ...
                    @enderror
                     ...
                     <div class="mb-2">
                        ...
                        <input type="number" min="0.00" step="0.01" max="1000.0" id="price" name="price" class="bg-transparent border  text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5 dark:text-white 
