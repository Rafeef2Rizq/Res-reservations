            ...
            <div class="m-2 p-2">
                ...
                <form method="post" action="{{route('admin.table.store')}}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="name" name="name" class="bg-transparent border text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5 dark:text-white
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" min="0" id="guest_number" name="guest_number" class="bg-transparent border text-gray-900 sm:text-sm rounded-lg focus:ring-2 focus:ring-fuchsia-50 focus:border-fuchsia-300 block w-full p-2.5 dark:text-white
